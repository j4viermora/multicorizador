class Admin::FooterLinksController < ApplicationController
  ...
  def create
    ...
    if @footer_link.save
      redirect_to admin_landing_path, notice: "Enlace creado."
    else
  ...
  def update
    if @footer_link.update(footer_link_params)
      redirect_to admin_landing_path, notice: "Enlace actualizado."
    else
  ...
  def destroy
    @footer_link.destroy
    redirect_to admin_landing_path, notice: "Enlace eliminado."
  end
