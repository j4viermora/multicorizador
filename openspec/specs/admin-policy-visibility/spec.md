...
Define la visibilidad de pólizas para usuarios `super_admin` en el namespace `/admin`: un listado global de pólizas (cross-tenant), filtrable por canal de venta, y totales por canal en el dashboard de administración.
