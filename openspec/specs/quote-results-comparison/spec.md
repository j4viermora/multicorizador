...
Define cómo se presentan y comparan los resultados de una cotización entre varios proveedores: agrupación, orden, coberturas visibles y estados parciales (cotizando, error de proveedor, sin resultados).
